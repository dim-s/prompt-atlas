...
| Google Gemini 3.x | `thinking_level` (**3.7 Flash: low/medium/high, default `medium`**; others: minimal/low/medium/high) | Gemini CLI flags / settings, API param |
...
**Google Gemini signals:** path under `.gemini/`, filename `GEMINI.md`, mentions of Gemini / Gemini CLI / `thinking_level` / `thinking_budget` / `response_json_schema` / `google-genai` / Google AI Studio / Vertex AI, frontmatter with `model: gemini-3.x` (incl. `gemini-3.7-flash`, `gemini-3.6-flash`, `gemini-3.5-flash-lite`).
...
Gemini options: **Gemini 3.1 Pro** (Pro-tier frontier) / **Gemini 3.7 Flash** (current Flash frontier, Aug 2026 — default `thinking_level` medium) / **Gemini 3.6 Flash** (previous Flash, Jul 2026) / **Gemini 3.5 Flash** / **Gemini 3 Flash** / **Gemini 3.5 Flash-Lite** (Jul 2026, vendor-designated subagent tier) / **Gemini 3.1 Flash-Lite** / **Universal Gemini 3.x** / 2.5 (legacy). *Gemini 3.5 Flash Cyber exists but is closed-access (governments / trusted partners via CodeMender) — not a reviewable target.*
...
**Recent June–August 2026 updates worth flagging in reviews:**
...
> "Which model is this prompt for — Claude (Fable 5 / Opus 5 / Opus 4.8 / 4.7 / Sonnet 5 / Sonnet 4.6 / Haiku 4.5), OpenAI GPT-5.x in Codex CLI (5.6 Sol/Terra/Luna / 5.5 / 5.4 / 5.3), Google Gemini 3.x (3.1 Pro / 3.7 Flash / 3.6 Flash / 3.5 Flash-Lite), Moonshot Kimi (K3 / K2.7-Code / K2.6), Z.ai GLM-5.3-Flash / 5.3 / 5.2 / 5.1 / 5 / 4.6, Alibaba Qwen3.8-Max / 3.8-Flash / 3.7-Max / 3.6, DeepSeek V4-Pro / Flash / Vision-Exp, xAI Grok 4.6 / 4.5 / 4.3, Mistral frontier, Meta Muse Spark 1.2 / Glimmer, Tencent Hy4, or cross-vendor?"
